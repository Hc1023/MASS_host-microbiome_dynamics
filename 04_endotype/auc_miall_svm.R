...
auc_mat1 = pred_fun(var = "APACHEII_24h", m = 'SVM')
auc_mat2 = pred_fun(var = vars_CTSg, m = 'SVM')
auc_mat3 = pred_fun(var = vars_m, m = 'SVM')
auc_mat4 = pred_fun(var = c(vars_CTSg, vars_m), m = 'SVM')
...
auc_mat1_D4 = pred_fun(var = "APACHEII_24h", tps = 28, m = 'SVM')
auc_mat2_D4 = pred_fun(var = vars_CTSg, tps = 28, m = 'SVM')
auc_mat3_D4 = pred_fun(var = vars_m, tps = 28, m = 'SVM')
auc_mat4_D4 = pred_fun(var = c(vars_CTSg, vars_m), tps = 28, m = 'SVM')
...
auc_mat1_D7 = pred_fun(var = "APACHEII_24h", tps = 28, m = 'SVM')
auc_mat2_D7 = pred_fun(var = vars_CTSg, tps = 28, m = 'SVM')
auc_mat3_D7 = pred_fun(var = vars_m, tps = 28, m = 'SVM')
auc_mat4_D7 = pred_fun(var = c(vars_CTSg, vars_m), tps = 28, m = 'SVM')
...
pdf(paste0("Outputs/04_auc_all_miall_svm.pdf"), width = 7, height = 2.5)
print(p)
dev.off()
...
if(F){
  ...
  write.csv(res1, 'Outputs/Supplementary_data_auc_miall_svm.csv',
            row.names = F)
